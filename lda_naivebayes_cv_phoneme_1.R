...
index.min.rf.temp <- which.min(misclass.training.trees)
ntree.rf.temp <- rf.tune.comb[index.min.rf.temp,1]
maxnode.rf.temp <- rf.tune.comb[index.min.rf.temp,2]
...
x11(pointsize = 9)
boxplot(misclass.training, at=1:12, las=2, names = c("lda","qda","mlr","lasso","nb_g","nb_g_pca","nb_k","nb_k_pca","cv-min","cv-1se","cv-def","randomforest"), main="boxplot training")

x11(pointsize = 9)
boxplot(misclass.testing, at=1:12, las=2, names = c("lda","qda","mlr","lasso","nb_g","nb_g_pca","nb_k","nb_k_pca","cv-min","cv-1se","cv-def","randomforest"), main="boxplot testing")

x11(pointsize = 9)
boxplot(relative.misclass.testing, at=1:12, las=2, names = c("lda","qda","mlr","lasso","nb_g","nb_g_pca","nb_k","nb_k_pca","cv-min","cv-1se","cv-def","randomforest"), main="boxplot relative testing")
